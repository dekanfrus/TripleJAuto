<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="hoses.aspx.cs" Inherits="TripleJAuto.hoses" %>
...
WHERE (Category.CategoryName = 'Hoses')"></asp:SqlDataSource>
</asp:Content>
