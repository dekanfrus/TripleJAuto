<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="timingParts.aspx.cs" Inherits="TripleJAuto.timingParts" %>
...
WHERE (Category.CategoryName = 'Timing Parts')"></asp:SqlDataSource>
</asp:Content>
