<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="paint.aspx.cs" Inherits="TripleJAuto.WebForm21" %>
...
WHERE (Category.CategoryName = 'Paint')"></asp:SqlDataSource>
</asp:Content>
