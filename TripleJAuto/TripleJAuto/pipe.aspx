<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="pipe.aspx.cs" Inherits="TripleJAuto.WebForm29" %>
...
WHERE (Category.CategoryName = 'Pipe')"></asp:SqlDataSource>
</asp:Content>
