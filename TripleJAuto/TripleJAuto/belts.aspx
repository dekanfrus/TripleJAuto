<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="belts.aspx.cs" Inherits="TripleJAuto.belts" %>
...
WHERE (Category.CategoryName = 'Belts')"></asp:SqlDataSource>
</asp:Content>
