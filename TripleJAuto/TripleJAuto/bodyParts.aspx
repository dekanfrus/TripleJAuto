<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="bodyParts.aspx.cs" Inherits="TripleJAuto.WebForm19" %>
...
WHERE (Category.CategoryName = 'Body Parts')"></asp:SqlDataSource>
</asp:Content>
