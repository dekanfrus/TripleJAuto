<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="clamps.aspx.cs" Inherits="TripleJAuto.WebForm28" %>
...
WHERE (Category.CategoryName = 'Clamps')"></asp:SqlDataSource>
</asp:Content>
