<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="ac_compressor.aspx.cs" Inherits="TripleJAuto.WebForm7" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebsiteConnectionString %>" SelectCommand="SELECT PartName, PartCost, PartDesc FROM Part WHERE (CategoryID = 1)"></asp:SqlDataSource>
</asp:Content>
