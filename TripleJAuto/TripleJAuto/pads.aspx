<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="pads.aspx.cs" Inherits="TripleJAuto.WebForm14" %>
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebsiteConnectionString %>" SelectCommand="SELECT PartName, PartCost, PartDesc FROM Part WHERE (CategoryID = 5)"></asp:SqlDataSource>
</asp:Content>
