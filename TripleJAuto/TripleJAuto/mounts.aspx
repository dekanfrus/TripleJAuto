<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="mounts.aspx.cs" Inherits="TripleJAuto.WebForm24" %>
...
WHERE (Category.CategoryName = 'Mounts')"></asp:SqlDataSource>
</asp:Content>
