...
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebsiteConnectionString %>" SelectCommand="SELECT PartName, PartCost, PartDesc FROM Part WHERE (CategoryID = 2)"></asp:SqlDataSource>
</asp:Content>
