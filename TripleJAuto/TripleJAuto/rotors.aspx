<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="rotors.aspx.cs" Inherits="TripleJAuto.WebForm13" %>
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebsiteConnectionString %>" SelectCommand="SELECT PartName, PartCost, PartDesc FROM Part WHERE (CategoryID = 6)"></asp:SqlDataSource>
</asp:Content>
