<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="batteries.aspx.cs" Inherits="TripleJAuto.WebForm16" %>
...
WHERE (Category.CategoryName = 'Battery')"></asp:SqlDataSource>
</asp:Content>
