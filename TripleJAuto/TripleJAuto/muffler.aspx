<%@ Page Title="" Language="C#" MasterPageFile="~/Parts.master" AutoEventWireup="true" CodeBehind="muffler.aspx.cs" Inherits="TripleJAuto.WebForm30" %>
...
WHERE (Category.CategoryName = 'Muffler')"></asp:SqlDataSource>
</asp:Content>
